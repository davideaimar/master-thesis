...
\noindent \textbf{\Large Indexing smart contracts based on semantic extracted from the blockchain} \\



\vspace{5.5cm}
\noindent Master's thesis in Computer Engineering \\
Supervisor: Valentina Gatteschi \\
Co-supervisor: Mariusz Nowostawski \\
Sempember 2023 \\

\vspace{0.2cm}
\noindent Politecnico di Torino \\
Collegio di Ingegneria Informatica, \\
del Cinema e della Meccatronica \\
