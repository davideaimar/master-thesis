...
The repository containing the code of eth2dgraph is available online along with an explanation of how to run the tool.

\subsection*{Github repository link}
\begin{itemize}
    \item \url{https://github.com/davideaimar/eth2dgraph}
\end{itemize}
...
Here are both the DQL and GraphQL specifications of the schema of the data extracted. 
